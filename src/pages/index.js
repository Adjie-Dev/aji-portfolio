      ...
      <main className="flex items-center text-dark w-full min-h-screen dark:text-light">
        <Layout className="pt-0 md:p-16 sm:p-8">
          <div className="flex items-center justify-between w-full lg:flex-col">
            <div className='w-1/2 md:w-full md:mb-7'>
              <Image src={profilPicture} alt="Aji" className="w-full h-auto md:inline-block lg:hidden md:w-full bg-transparent" priority
            ...
            <div className='flex w-1/2 flex-col items-center self-center lg:w-full lg:text-center'>
              ...
              <div className='flex items-center self-start mt-2 lg:self-center'>
                ...
                <Link href="mailto:alhafidzw1@gmail.com" className='ml-4 text-lg font-medium capitalize text-dark underline dark-text-light dark:text-light md:text-base'>Contact</Link>
              </div>
            </div>
          </div>
        </Layout>
